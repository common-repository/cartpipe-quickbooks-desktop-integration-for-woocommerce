...
class CPD_API_Client {
	...
	public function get_payment_methods( ) {
		return $this->_make_api_call( 'qb/payment_methods' );
	}
	public function get_sales_tax_classes( ) {
		return $this->_make_api_call( 'qb/sales_tax_classes');
	}
	public function get_sales_tax_rates() {
		return $this->_make_api_call( 'qb/sales_tax_rates' );
	}
	public function get_license_info( $license ) {
		return $this->_make_api_call( 'qb/license/' . $license . '/get' );
	}                                                                                                                   
	public function get_unposted_orders( ) {
		return $this->_make_api_call( 'qb/orders/unposted');
	}
	public function get_posted_orders(  ){
		return $this->_make_api_call( 'qb/orders/posted' );
	}
	public function get_failed_orders(  ){
		return $this->_make_api_call( 'qb/orders/failed' );
	}
	public function get_all_products( ) {
		return $this->_make_api_call( 'qb/items/all/get');
	}
	public function get_synced_products( ) {
		return $this->_make_api_call( 'qb/items/synced/get');
	}
	...
	private function _make_api_call( $endpoint, $params = array(), $method = 'GET' ) {
		...
		//error_log(print_r($this->_api_url . $endpoint . $paramString, true), 3, plugin_dir_path(__FILE__) . "/qbo.log");
